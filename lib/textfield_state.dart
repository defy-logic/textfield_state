...
class TextFieldState {
  ...
  bool get _usesFocusNode => focusChanged != null || primaryFocusChanged != null;
  ...
  void _updateController(TextEditingController? widgetController, String? text) {
    if (widgetController != _widgetController) {
      ...
      if (hadController) {
        ...
        if (!hasController) {
          ...
          if (text != null && text != _widgetInitialText && text != _widgetController?.text) {
            _controller = TextEditingController(text: text);
          } else {
            _controller = TextEditingController.fromValue(_widgetController?.value);
          }
    ...
    if (_controller != null) {
      final dirty = text != null && text != _widgetInitialText && text != _controller?.text;
  ...
  void _updateFocusNode(FocusNode? widgetFocusNode) {
    ...
    // Ensure initialized
    if (_widgetFocusNode == null && _focusNode == null) {
